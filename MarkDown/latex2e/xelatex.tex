...
%%% Doc Base
\usepackage{natbib}
\bibliographystyle{authoryear-ibid} %plainnat,amsplain
...
\graphicspath{{./Imágenes/Generados/}{./Imágenes/}}
...
\begin{document}
  ...
  \newcommand{\umsslogo}{
    \adjustbox{valign=t,width=2.5cm}{\input{Imágenes/umss.tex}}
  }

  \newcommand{\fcytlogo}{
    \adjustbox{valign=t,width=2.5cm}{\input{Imágenes/fcyt.tex}}
  }
