...
## --use-part-section
rst2xetex --section-numbering --template=latex2e/xelatex.tex --documentclass=book --documentoptions=11pt,twoside,letterpaper --use-latex-docinfo --section-subtitles --smart-quotes=yes -g -l es $nombreArchivo.rst $nombreArchivo.tex
